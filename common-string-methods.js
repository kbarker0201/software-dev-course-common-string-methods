...
let initialQuote = "Learning JavaScript is fun!";
let hasJS = initialQuote.includes("JavaScript");
let positionOfFun = initialQuote.indexOf("fun");

let secondQuote = "CODE BOOTCAMP";
let lowerSecond = secondQuote.toLowerCase();
let replacedSecond = secondQuote.replace("bootcamp", "JavaScript");

let thirdQuote = "Coding is fun and educational";
let thirdNew = thirdQuote.split(", ");

let fourthQuote = "Coding bootcamp";
let fourthCharacter = fourthQuote.charAt(7);
let fourthExtracted = fourthQuote.slice(12, 15);
